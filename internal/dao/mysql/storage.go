...
const defaultRoundRobinLocationName = "bs-tab-1"
const mysqlDialerContextName = "bs-conn"

const metaStoreTableName = "blog_service_meta"
...
func NewMySQLStorageEngine(userName, password, networkAddress, socketPath, databaseName string) (storage bsinterfaces.StorageEngine, err error) {
...
func NewMySQLRoundRobinStorageEngine(userName, password string, networkAddresses []string, socketPath, databaseName string) (storage bsinterfaces.StorageEngine, err error) {
